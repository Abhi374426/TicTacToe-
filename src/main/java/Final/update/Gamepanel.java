 ...
 Gamepanel(String player1,String player2,int total_series){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==jb8){
            ...
            jb8.setFont(new Font("Arail",1,50));
...
//        digonal
        ...
        if(win==true){
            series_count=series_count+1;
             if(xo_value.equals("x")){
               who_player_win=player1;
               player1_win_count=player1_win_count+1;
             }
             else{
           who_player_win=player2;
           player2_win_count=player2_win_count+1;
             }
             String win_title=who_player_win+" ("+xo_value+")"+" wins";
    ...
    void restartGame(){
        ...
        if (total_series>=series_count) {
            int i= JOptionPane.showConfirmDialog(jf, "DO you want to restart the the game ?");
               ...
               jb5.setText("");
                jb6.setText("");
                 jb7.setText("");
                  ...
                  if (who_player_win.equals(player1)) {
                  ...
                  jf.setTitle(who_player_win+"("+xo_value+")turns");
